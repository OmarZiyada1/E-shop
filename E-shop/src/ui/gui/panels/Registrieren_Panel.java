...
public class Registrieren_Panel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Registrieren_Panel(JPanel mainPanel, JPanel switchSidePanel, JPanel panel_header_nav, E_Shop shop) {
	...
	private void addLoginPanel() {
		mainPanel.removeAll();
		mainPanel.add(new Login_Panel(mainPanel, switchSidePanel, panel_header_nav, this.shop), BorderLayout.CENTER);
		mainPanel.validate();
	}
